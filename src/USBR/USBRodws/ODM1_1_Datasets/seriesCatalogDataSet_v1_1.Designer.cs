...
FROM         SeriesCatalog";
            ...
            this._commandCollection[1].CommandText = @"SELECT        SeriesID, SiteID, SiteCode, SiteName, VariableID, VariableCode, VariableName, Speciation, VariableUnitsID, VariableUnitsName, SampleMedium, ValueType, 
...
WHERE        (SiteID = @siteID) AND (VariableID = @variableID)";
        ...
        public virtual int FillBySeriesID(seriesCatalogDataSet.SeriesCatalogDataTable dataTable, int SeriesID) {
            this.Adapter.SelectCommand = this.CommandCollection[1];
            this.Adapter.SelectCommand.Parameters[0].Value = ((int)(SeriesID));
            if ((this.ClearBeforeFill == true)) {
                dataTable.Clear();
            }
            int returnValue = this.Adapter.Fill(dataTable);
        ...
        public virtual seriesCatalogDataSet.SeriesCatalogDataTable GetDataBySeriesID(int SeriesID) {
            this.Adapter.SelectCommand = this.CommandCollection[1];
            this.Adapter.SelectCommand.Parameters[0].Value = ((int)(SeriesID));
            seriesCatalogDataSet.SeriesCatalogDataTable dataTable = new seriesCatalogDataSet.SeriesCatalogDataTable();
            this.Adapter.Fill(dataTable);
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Fill, false)]
        public virtual int FillBySiteVariable(seriesCatalogDataSet.SeriesCatalogDataTable dataTable, global::System.Nullable<int> siteID, global::System.Nullable<int> variableID) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Select, false)]
        public virtual seriesCatalogDataSet.SeriesCatalogDataTable GetDataBySiteVariable(global::System.Nullable<int> siteID, global::System.Nullable<int> variableID) {
            this.Adapter.SelectCommand = this.CommandCollection[3];
            if ((siteID.HasValue == true)) {
                this.Adapter.SelectCommand.Parameters[0].Value = ((int)(siteID.Value));
            }
