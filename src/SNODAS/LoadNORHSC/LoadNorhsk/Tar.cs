...
// to allow fast ngen
//[assembly: AssemblyTitle("Tar.cs")]
//[assembly: AssemblyDescription("A quick and easy TAR library, for reading or writing the Unix(tm) tar file formt")]
//[assembly: AssemblyConfiguration("")]
//[assembly: AssemblyCompany("Dino Chiesa")]
//[assembly: AssemblyProduct("Tools")]
//[assembly: AssemblyCopyright("Copyright � Dino Chiesa 2009, 2010")]
                ...
                while ((n = fs.Read(block, 0, block.Length)) > 0)
                {
                    ...
                    if (wantExtract)
                    {
                        switch (entry.Type)
                        {
                            ...
                            case TarEntryType.File:
                            case TarEntryType.File_Contiguous:
                                string path = Path.GetDirectoryName(archive);
                                
                                 //string ext = Path.GetExtension(archive);
                                 //string path = archive.Replace(ext, "");
