...
FROM         SeriesCatalog";
            ...
            this._commandCollection[2].CommandText = @"SELECT        SeriesID, SiteID, SiteCode, SiteName, VariableID, VariableCode, VariableName, Speciation, VariableUnitsID, VariableUnitsName, SampleMedium, ValueType, 
                         TimeSupport, TimeUnitsID, TimeUnitsName, DataType, GeneralCategory, MethodID, MethodDescription, SourceID, Organization, SourceDescription, Citation, 
                         QualityControlLevelID, QualityControlLevelCode, BeginDateTime, EndDateTime, BeginDateTimeUTC, EndDateTimeUTC, ValueCount
FROM            SeriesCatalog
WHERE        (SiteID = @siteID) AND (VariableCode = @variableCode)";
            ...
            this._commandCollection[2].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@variableCode", global::System.Data.SqlDbType.NVarChar, 50, global::System.Data.ParameterDirection.Input, 0, 0, "VariableCode", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._commandCollection[3] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[3].Connection = this.Connection;
            this._commandCollection[3].CommandText = @"SELECT        SeriesID, SiteID, SiteCode, SiteName, VariableID, VariableCode, VariableName, Speciation, VariableUnitsID, VariableUnitsName, SampleMedium, ValueType, 
                         TimeSupport, TimeUnitsID, TimeUnitsName, DataType, GeneralCategory, MethodID, MethodDescription, SourceID, Organization, SourceDescription, Citation, 
                         QualityControlLevelID, QualityControlLevelCode, BeginDateTime, EndDateTime, BeginDateTimeUTC, EndDateTimeUTC, ValueCount
FROM            SeriesCatalog
WHERE        (SiteID = @siteID) AND (VariableID = @variableID)";
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Fill, false)]
        public virtual int FillBySiteIDVariableCode(seriesCatalogDataSet.SeriesCatalogDataTable dataTable, global::System.Nullable<int> siteID, string variableCode) {
            ...
            if ((variableCode == null)) {
                ...
                this.Adapter.SelectCommand.Parameters[1].Value = ((string)(variableCode));
            }
            if ((this.ClearBeforeFill == true)) {
                dataTable.Clear();
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Select, false)]
        public virtual seriesCatalogDataSet.SeriesCatalogDataTable GetDataBySiteIDVariableCode(global::System.Nullable<int> siteID, string variableCode) {
            this.Adapter.SelectCommand = this.CommandCollection[2];
            if ((siteID.HasValue == true)) {
                this.Adapter.SelectCommand.Parameters[0].Value = ((int)(siteID.Value));
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Fill, false)]
        public virtual int FillBySiteIDVariableID(seriesCatalogDataSet.SeriesCatalogDataTable dataTable, global::System.Nullable<int> siteID, global::System.Nullable<int> variableID) {
            ...
            if ((variableID.HasValue == true)) {
                this.Adapter.SelectCommand.Parameters[1].Value = ((int)(variableID.Value));
            }
            else {
                this.Adapter.SelectCommand.Parameters[1].Value = global::System.DBNull.Value;
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Select, false)]
        public virtual seriesCatalogDataSet.SeriesCatalogDataTable GetDataBySiteIDVariableID(global::System.Nullable<int> siteID, global::System.Nullable<int> variableID) {
            this.Adapter.SelectCommand = this.CommandCollection[3];
            if ((siteID.HasValue == true)) {
                this.Adapter.SelectCommand.Parameters[0].Value = ((int)(siteID.Value));
            }
