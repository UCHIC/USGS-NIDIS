...
SELECT VariableID, VariableCode, VariableName, Speciation, VariableUnitsID, SampleMedium, ValueType, IsRegular, TimeSupport, TimeUnitsID, DataType, GeneralCategory, NoDataValue FROM Variables WHERE (VariableID = @VariableID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[1].CommandText = @"SELECT        VariableID, VariableCode, VariableName, Speciation, VariableUnitsID, SampleMedium, ValueType, IsRegular, TimeSupport, TimeUnitsID, DataType, GeneralCategory, 
                         NoDataValue
FROM            Variables
WHERE        (VariableID IN
                             (SELECT        VariableID
            ...
            this._commandCollection[1].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@siteID", global::System.Data.SqlDbType.Int, 4, global::System.Data.ParameterDirection.Input, 0, 0, "", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
        ...
        public virtual int FillBySiteID(VariablesDataset.VariablesDataTable dataTable, global::System.Nullable<int> siteID) {
        ...
        public virtual VariablesDataset.VariablesDataTable GetDataBySiteID(global::System.Nullable<int> siteID) {
            this.Adapter.SelectCommand = this.CommandCollection[1];
            if ((siteID.HasValue == true)) {
                this.Adapter.SelectCommand.Parameters[0].Value = ((int)(siteID.Value));
            }
